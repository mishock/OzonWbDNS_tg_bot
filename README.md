...
- `/start` — приветствие в стиле ТЗ (**AKEM-bot**, маркетплейсы) и кнопка «Выбрать категорию».
- `/help` — справка по командам и кнопкам (раздел 1.1 ТЗ про командные боты).
- Меню категорий через `InlineKeyboardMarkup`.
- Выбор категории и постраничная выдача товаров (по 3).
- Карточка товара по п. 2.5 ТЗ: название, цена, площадка, ссылка; рейтинг — если указан в данных.
- Кнопки управления по п. 2.6 ТЗ: «Показать ещё», «Новый поиск», «Другие категории».
